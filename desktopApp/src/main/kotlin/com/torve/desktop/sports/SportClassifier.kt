package com.torve.desktop.sports

/**
 * Buckets a release-name string into a coarse sport category. Used by
 * the Sports page filter pills so users can narrow scenenzbs cat=5060
 * results (which mix every sport into one feed) to just the league
 * they care about.
 *
