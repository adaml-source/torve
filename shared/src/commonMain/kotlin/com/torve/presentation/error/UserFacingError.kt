...
val defaultUserFacingMessages: Map<String, String> = mapOf(
    ...
    // Premium
    "error_no_entitlement" to "A premium subscription is required.",
    "error_premium_required" to "This feature requires Torve Pro.",
    // Billing
    "error_billing_unavailable" to "In-app purchases are not available right now.",
    "error_billing_init_failed" to "Could not connect to the store. Please try again.",
    "error_purchase_failed" to "Purchase could not be completed. Please try again.",
    "error_product_not_available" to "This product is not available right now.",
    "error_already_owned" to "You already own this product.",
    // Network
