        ...
        Column(
            ...
            Row(
                ...
                TextButton(
                    ...
                    Text(
                        "Select All",
                        color = if (noneHidden) StreamVault.colors.textHint else Amber,
                ...
                TextButton(
                    ...
                    Text(
                        "Deselect All",
                        color = if (allHidden) StreamVault.colors.textHint else StreamVault.colors.error,
                        style = MaterialTheme.typography.labelLarge,
                        fontWeight = FontWeight.SemiBold,
                    )
                }
                        ...
                        Row(
                            ...
                            IconButton(
                                ...
                                Icon(
                                    ...
                                    tint = if (allCountryHidden) StreamVault.colors.textHint else Amber,
...
private fun CategoryToggleRow(
    ...
    Row(
        ...
        Icon(
            ...
            tint = if (isHidden) StreamVault.colors.textHint else Amber,
        ...
        Text(
            ...
            color = if (isHidden) StreamVault.colors.textHint else Snow,
        ...
        Text(
            ...
            color = if (isHidden) StreamVault.colors.textHint else Ash,
        )
    }
}
