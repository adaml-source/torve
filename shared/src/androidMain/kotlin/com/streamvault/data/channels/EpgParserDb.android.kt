...
internal suspend fun EpgParser.parseXmlTvStreamingToDb(
    ...
    fun flushBatches() {
        ...
        db.streamVaultQueries.transaction {
            channelBatch.forEach { row ->
                db.streamVaultQueries.insertEpgChannel(
            ...
            programmeBatch.forEach { row ->
                db.streamVaultQueries.insertEpgProgramme(
                    playlist_id = playlistId,
                    generation_id = generationId,
                    channel_id = row.channelId,
                    epg_channel_key = row.epgChannelKey,
    ...
    db.streamVaultQueries.clearEpgProgrammesForPlaylistGeneration(playlistId, generationId)
    db.streamVaultQueries.clearEpgChannelsForPlaylistGeneration(playlistId, generationId)
