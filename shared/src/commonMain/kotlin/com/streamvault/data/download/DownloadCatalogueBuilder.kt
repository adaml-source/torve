...
import com.streamvault.domain.model.DownloadCataloguePrefs
import com.streamvault.domain.model.DownloadGroup
import com.streamvault.domain.model.DownloadGroupType
import com.streamvault.domain.model.DownloadMediaType
import com.streamvault.domain.model.DownloadSeason
        ...
        return when (prefs.groupingMode) {
            ...
            CatalogueGrouping.BY_QUALITY -> {
                groups
                    ...
                    .toSortedMap(compareByDescending { resolutionRank(it) })
