...
data class BetaProgramSettingsCardState(
    val title: String = "Torve Beta Program",
    val subtitle: String = "Apply for beta tester access. Free beta premium access ends July 31, 2026.",
    val badge: String? = null,
)

object BetaProgramCopy {
    const val SETTINGS_TITLE = "Torve Beta Program"
    const val SETTINGS_DEFAULT_SUBTITLE = "Apply for beta tester access. Free beta premium access ends July 31, 2026."
    ...
    const val DEADLINE = "Free beta premium access ends July 31, 2026. Beta tester opt-in can continue without free premium access."
    const val EMAIL_VERIFICATION = "Beta applications require a verified Torve account email."
    const val PREMIUM_TESTER_APPLICATION = "You already have premium access. You can still apply to test upcoming beta builds and features."
    const val FREE_PREMIUM_NON_PREMIUM_ONLY = "Beta free premium access is only for approved non-premium testers and ends July 31, 2026."
