 ...
 *
 * Raw group titles from IPTV providers are messy:
...
object CategoryNameCleaner {
    ...
    // Junk patterns often seen in IPTV group titles
    ...
    fun clean(rawName: String): CleanResult {
        ...
        // 6. Title case if the name is ALL CAPS (most IPTV providers use ALL CAPS)
    ...
    fun processCategories(
        ...
        val merged = cleaned.groupBy { it.cleanedName.lowercase() }
            ...
            .sortedWith(
                compareBy<IptvCategory> { it.countryCode?.lowercase() ?: "zzz" }
