...
object WatchStatsTvUiModel {
    ...
    private fun advancedModel(
        ...
        WatchStatsTvDashboardModel(
            ...
            lockedTitle = if (!isPremium) "Unlock deeper watch insights" else null,
            lockedBody = if (!isPremium) "Advanced metadata filters and drilldowns are included with Premium. Basic truthful stats remain available." else null,
        )
    ...
    private fun ratingModel(
        ...
        WatchStatsTvDashboardModel(
            ...
            lockedTitle = if (!isPremium) "Unlock deeper watch insights" else null,
            lockedBody = if (!isPremium) "Rating distribution and richer metadata drilldowns are included with Premium. No sample data is shown." else null,
        )
