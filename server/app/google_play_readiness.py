...
Google Play purchases right now?" Called from three places:
  ...
  2. /me/health/integrations — surfaces readiness to the client's
     diagnostics screen.
  3. purchase_verify._verify_google_play_token — fail-closed gate so
     misconfigured deployments return a stable error_code instead of
...
def assess_readiness() -> GooglePlayReadiness:
    ...
    purchase verification as a fail-closed gate.
    """
