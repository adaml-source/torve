...
tasks.register("verifyPackagedDesktopUpdateMetadata") {
    ...
    val expectedVersion = (project.findProperty("torveMsiVersion") as String?) ?: "1.3.9"
...
tasks.register("packageMsiCloseApp") {
    ...
    val torveVersion = (project.findProperty("torveMsiVersion") as String?) ?: "1.3.9"
...
compose.desktop {
    application {
        ...
        val torveAppVersion = (project.findProperty("torveMsiVersion") as String?) ?: "1.3.9"
