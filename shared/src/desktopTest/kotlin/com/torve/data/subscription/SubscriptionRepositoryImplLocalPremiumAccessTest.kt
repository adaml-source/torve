...
class SubscriptionRepositoryImplLocalPremiumAccessTest {
    ...
    @Test
    fun expiredLocalSubscriptionReturnsFalse() = runTest {
        val now = Clock.System.now().toEpochMilliseconds()
        val fixture = fixture()
        fixture.database.insertSubscription(expiresAt = now - 1L)
        fixture.settings.cacheVerifiedSnapshot(verifiedAtMs = now)

        assertFalse(fixture.repository.hasLocallyVerifiedPremiumAccess())
    }

    @Test
    fun wrongPrincipalReturnsFalse() = runTest {
        val now = Clock.System.now().toEpochMilliseconds()
        val fixture = fixture()
        fixture.database.insertSubscription(expiresAt = now + 60_000L)
    ...
    @Test
    fun clearedLocalEntitlementReturnsFalse() = runTest {
        val fixture = fixture()
    ...
    @Test
    fun locallyStoredDeviceDeactivationReturnsFalse() = runTest {
        val now = Clock.System.now().toEpochMilliseconds()
        val fixture = fixture()
        fixture.database.insertSubscription(expiresAt = now + 60_000L)
