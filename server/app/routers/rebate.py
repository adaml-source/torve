...
class AdminCreateRequest(BaseModel):
    ...
    # Grant duration on redemption. None / 0 / negative → lifetime grant
    # (default, preserves existing behaviour). Positive integer → grants
    # a subscription_monthly entitlement that expires N days after the
...
def redeem_rebate_code(
    ...
    """Redeem a Torve rebate code for lifetime access."""
