...
> Cross-platform features (catalog, search, watchlist, sync, entitlements,
...
| Feature | Where | Notes |
|---|---|---|
| Settings page | `desktop/ui/v2/settings/V2SettingsPage.kt` | Account, Subscription, Playback, Subtitles, Display, Add-ons, Playlists, Trakt, SIMKL, Plex, Diagnostics & Updates, Storage, Maintenance. |
...
| Device limit reached | `desktop/ui/v2/device/V2DeviceLimitReachedScreen.kt` | Shown after subscription verify if cap is hit. |
| Subscription verify (Google Play) | KMP `SubscriptionRepositoryImpl` | Backend-aware. |
