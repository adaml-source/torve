...
object DesktopPremiumStateHolder {
    ...
    /** Read-only StateFlow used by gated UI. Defaults to false until refresh lands. */
    ...
    /** True when the backend says the user has usable premium access. */
    fun isPremium(): Boolean = instance?.hasPremium?.value ?: false
